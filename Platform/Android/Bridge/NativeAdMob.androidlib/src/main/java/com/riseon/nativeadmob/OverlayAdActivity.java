...
public final class OverlayAdActivity extends Activity {
    ...
    static void DismissSession(String targetSessionId) {
        RunOnMainThread(() -> {
            ...
            OverlayAdActivity activity = targetSession.activity;
            if (activity != null) {
    ...
    private void ReleaseContentView() {
        OverlayAdContentView currentContentView = contentView;
        contentView = null;
    ...
    private static final Application.ActivityLifecycleCallbacks
            ...
            new Application.ActivityLifecycleCallbacks() {
                ...
                public void onActivityResumed(Activity activity) {
                    if (activity instanceof OverlayAdActivity) return;
