...
namespace RiseOn.NativeAdMob.Editor {
    ...
    internal sealed class EditorAd : MonoBehaviour {
        ...
        // sitting on the maths axis rather than centered in its box.
        ...
        private RectTransform CreatePanel(
            ...
            // The device paints exactly the color the caller named, so the
            // preview does too - INCLUDING a fully transparent one. Reading
            // alpha 0 as "nothing was set" and substituting a house color
        ...
        // own graphic - a transparent color, a real answer on the device,
        ...
        // the center stretches. Rasterized from the rounded box's distance
