...
final class InFeedAdViewFactory {
    ...
    // arc's center sits r in from both edges, the asset's corner sits d in
    ...
    // the text centers under it. A centered icon over left-aligned lines
    ...
    private LinearLayout BuildHeadlineAndActionStack(
        ...
        // button, so it takes the whole remaining band and centers itself in it
        ...
        // the text centers under it exactly as it does beside a side media.
    ...
    private void ApplyTextMode(
        ...
        // One allowed line is not a license to scroll: a single-line text that
