...
namespace RiseOn.NativeAdMob {
    /// <summary>
    /// One color, one int, across three languages.<br/>
    /// The wire carries packed ARGB because that is what both native sides build a color from - Color.argb over there, the shift-and-mask in ROInFeedAdPresentation here - and because a float per channel would cost four parameters where the ABI check watches one.
    /// </summary>
